...
const Schools = () => {
  ...
  const [isUpdateSchoolModalShowing, setIsUpdateSchoolModalShowing] =
    useState(false);
  ...
  } = useGetSchoolsQuery(selectedFilterFields);
