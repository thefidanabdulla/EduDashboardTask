...
const CustomModal = ({ title, setIsModalShowing, children }: CustomModalProps) => {
  return (
    <div className='w-full h-screen fixed top-0 left-0 z-50 flex justify-center items-center p-6 overflow-y-auto bg-[#00000080]'>
      <div className='rounded-[20px] bg-white p-6 max-w-[550px] w-full flex flex-col gap-4'>
